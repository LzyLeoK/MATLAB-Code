% Predictive RMSE of LFGP, BLM, FPCM and BK for composite fuselages in irregular grid
...
% Predictive RMSE of LFGP, BLM, FPCM and BK for composite fuselages in regular grid
