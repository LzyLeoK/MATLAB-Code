% Predictive RMSE of LFGP, BLM, FPCM and BK for general functional outputs in irregular grid condition
...
figure
boxplot(RMSE1, 'Labels',{'LFGP','LFGP(id)','BLM','FPCM','BK'});
ylim([0.37,0.47]);
ylabel('RMSE','fontsize',16);

% Predictive RMSE of LFGP, BLM, FPCM and BK for general functional outputs in regular grid condition
...
figure
boxplot(RMSE2, 'Labels',{'LFGP','LFGP(id)','BLM','FPCM','BK'});
ylim([0.37,0.52]);
ylabel('RMSE','fontsize',16);