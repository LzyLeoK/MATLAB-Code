...
Figure 1: Predictive RMSE of LFGP, LFGP(id), BLM, FPCM and BK for general functional outputs in irregular grid condition, 
Figure 2: Predictive RMSE of LFGP, LFGP(id), BLM, FPCM and BK for general functional outputs in regular grid condition.
