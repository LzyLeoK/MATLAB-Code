% Predictive RMSE of LFGP, BLM, FPCM and BK for closed curves in irregular grid condition
...
figure
boxplot(RMSE, 'Labels',{'LFGP','LFGP(id)','BLM','FPCM','BK'});
ylim([0.25,0.7]);
ylabel('RMSE','fontsize',16);

% Predictive RMSE of LFGP, BLM, FPCM and BK for closed curves in regular grid condition
